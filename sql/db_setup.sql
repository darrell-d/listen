...
CREATE  TABLE IF NOT EXISTS `blog`.`comments` (`commentID` INT NOT NULL AUTO_INCREMENT ,`postID` INT NULL ,`name` VARCHAR(45) NULL , `comment` TEXT NULL, `time` VARCHAR(45) NULL ,PRIMARY KEY (`commentID`) );